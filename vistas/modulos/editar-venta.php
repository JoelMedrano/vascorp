              ...
              <?php
                ...
                foreach ($listaProducto as $key => $value) {
                    ...
                    <div class="col-xs-3">
                      ...
                      <input type="number" class="form-control nuevaCantidadProducto" name="nuevaCantidadProducto" min="1" value="'.$value["cantidad"].'" stock="'.$value["stock"].'" nuevoStock="'.$value["stock"].'" required>
